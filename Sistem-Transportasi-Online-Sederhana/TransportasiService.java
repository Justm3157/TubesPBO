...
public class TransportasiService {
    ...
    // =====================================================================
    public Pembayaran prosesPembayaranCash(Penumpang penumpang, Perjalanan perjalanan,
                                            Voucher voucher, Kendaraan kendaraan) {
        String kode = "T-" + System.currentTimeMillis(); // generate kode unik
        ...
        Persistensi.catatRiwayatPembayaran(bayar); // delegasi ke modul Persistensi

        System.out.println("[Service] Pembayaran Cash diproses. Kode: " + kode
                + " | Tarif: Rp " + bayar.getTarifFinal());
        return bayar;
    }

    public Pembayaran prosesPembayaranDigital(Penumpang penumpang, Perjalanan perjalanan,
                                               Voucher voucher, Kendaraan kendaraan,
                                               double admin, String provider) {
        ...
        System.out.println("[Service] Pembayaran Digital (" + provider + ") diproses. Kode: " + kode
                + " | Tarif: Rp " + bayar.getTarifFinal());
        return bayar;
    }
